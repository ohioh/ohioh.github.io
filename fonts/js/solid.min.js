...
!function () {
  ...
  var c = {};try {
  ...
  } catch (c) {}var h = (c.navigator || {}).userAgent,
      v = void 0 === h ? "" : h,
      l = c,
    ...
    !function c(h, l) {
      var v = Object.keys(l).reduce(function (c, h) {
        var v = l[h];return v.icon ? c[v.iconName] = v.icon : c[h] = v, c;
